const initialState = {
    ...
    objectTaxation: [
      { id: 1, value: 'Лесосека в целом', text: 'Лесосека в целом' },
      { id: 2, value: 'Волока', text: 'Волока' },
      { id: 3, value: 'Пасеки', text: 'Пасеки' },
      { id: 4, value: 'Погрузочные пункты', text: 'Погрузочные пункты' },
      { id: 5, value: 'Ленты перечета', text: 'Ленты перечета' },
      { id: 6, value: 'Прочие объекты', text: 'Прочие объекты' }
    ],	
    property: [
      { id: 1, value: 'Хвойное', },
